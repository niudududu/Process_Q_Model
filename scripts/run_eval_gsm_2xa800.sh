...
DATA_FILE="${DATA_FILE:-data/PQM/eval_data/gsm8k-plus-metamath-mistral-128.json}"
GSM_PLUS_FILE="${GSM_PLUS_FILE:-data/GSM-Plus/data/testmini-00000-of-00001.jsonl}"
SAVE_FILE="${SAVE_FILE:-${RUN_ROOT}/outputs/gsm-prm-scored.json}"
